          ...
          <div className="row">
            ...
            <div className="col-lg-4 col-md-6">
              <div className="single-services text-center">
                ...
                <p>
                Our creative design team collaborates closely with you to understand your vision, crafting robust architectures,
                delivering seamless user experiences with precision and innovation.
                </p>
              </div>
            </div>
